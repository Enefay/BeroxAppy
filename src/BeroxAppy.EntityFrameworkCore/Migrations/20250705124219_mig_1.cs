        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceGender = table.Column<int>(type: "int", nullable: false),
                    CalendarColor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    CanTakeOnlineReservation = table.Column<bool>(type: "bit", nullable: false),
                    FixedSalary = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ServiceCommissionRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ProductCommissionRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PackageCommissionRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ReservationIntervalMinutes = table.Column<int>(type: "int", nullable: false),
                    SendReminder = table.Column<bool>(type: "bit", nullable: false),
                    ReminderHoursBefore = table.Column<int>(type: "int", nullable: false),
                    SendCreatedNotification = table.Column<bool>(type: "bit", nullable: false),
                    AllowOnlineReservation = table.Column<bool>(type: "bit", nullable: false),
                    MinHoursBeforeOnlineReservation = table.Column<int>(type: "int", nullable: false),
                    MaxDaysForOnlineReservation = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationHistories_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificationHistories_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationDetails_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationHistories_CustomerId",
                table: "NotificationHistories",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationHistories_ReservationId",
                table: "NotificationHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationDetails_EmployeeId",
